...
UCLASS()
class BASIC_API AWeapon_Actor : public AItem
{
	GENERATED_BODY()
...
public:	
	...
	void SetAttackWeight(const EEquipState& equip_state, const EAttackStrength& attack_strength, const EAttackType& attack_type);
