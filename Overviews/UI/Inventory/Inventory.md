...
### * Add item to storage
  ...
  https://github.com/yolong1020/EldenRing/blob/91a7a54264022be27051620a753d14886cf3f565/Source/EldenRing/Private/System/StorageManager.cpp#L159-L172
  </br>
  ###### [04] 아이템 적재는 좌측 상단을 기준으로 시작되며, 기준점으로부터 아이템 크기까지 각 슬롯에 해당하는 아이템의 포인터를 할당합니다. 만약 위젯이 노출중에 있다면, 적재된 아이템이 노출될 수 있도록 InteractionGrid를 갱신합니다.
