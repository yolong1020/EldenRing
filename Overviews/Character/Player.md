...
2. ###### 'New Game' 혹은 'Load Game'에 따라 Item을 다르게 초기화합니다. Save & Load에 관한 자세한 내용은 하단 링크에서 확인이 가능합니다.
   https://github.com/yolong1020/EldenRing/blob/main/Overviews/System/SaveLoad/SaveLoad.md
   ```C++
   /// [BeginPlay] 189
